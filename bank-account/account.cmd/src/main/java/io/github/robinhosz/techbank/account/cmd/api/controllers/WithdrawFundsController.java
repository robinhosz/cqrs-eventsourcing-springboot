...
import io.github.robinhosz.techbank.account.cmd.api.commands.WithdrawFundsCommand;
...
public class WithdrawFundsController {
    ...
    public ResponseEntity<BaseResponse> withdrawFunds(@PathVariable(value = "id") String id, @RequestBody WithdrawFundsCommand command) {
        ...
        try {
            ...
            var safeErrorMessage = MessageFormat.format("Error while processing request to withdraw funds from bank account. Reason: {0}", e.toString());
